  ...
  return (
    ...
    >
      ...
      {banner.image_url ? (
        ...
        <div className="w-12 h-12 rounded-xl bg-slate-900 flex-col items-center justify-center shrink-0 hidden sm:flex leading-none gap-0.5">
      ...
      <div className="flex-1 min-w-0">
        {banner.advertiser_name && (
          <p className="text-xs font-bold text-slate-900 truncate">{banner.advertiser_name}</p>
        )}
        <p className="text-sm text-slate-600 truncate leading-snug">{banner.message}</p>
      </div>
